...
const orangeGrowthStages = [
  { image: orangeSeed, label: "씨앗", description: "시작의 설렘" },
  { image: orangeSprout, label: "새싹", description: "희망의 싹" },
  { image: orangeYoungTree, label: "어린나무", description: "성장하는 중" },
  { image: orangeFullTree, label: "풍성한 나무", description: "결실의 기쁨" },
  { image: orangeRipe, label: "익은 오렌지", description: "완성된 사랑" },
];
