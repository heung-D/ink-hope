      ...
      <div className="px-3 pb-5 flex flex-col gap-1.5">
        ...
        {isCollapsed ? (
          <Button
            onClick={onCompose}
            size="icon"
            className="w-full h-14 rounded-2xl bg-gradient-to-r from-amber-500 via-orange-500 to-orange-600 hover:from-amber-600 hover:via-orange-600 hover:to-orange-700 shadow-lg hover:shadow-xl transition-all duration-200"
          >
          ...
          <Button
            onClick={onCompose}
            className="w-full h-14 rounded-2xl text-base font-semibold bg-gradient-to-r from-amber-500 via-orange-500 to-orange-600 hover:from-amber-600 hover:via-orange-600 hover:to-orange-700 shadow-lg hover:shadow-xl transition-all duration-200 justify-center gap-2"
          >
